...
namespace QuanLyBanSach.GUI
{
    public partial class FormCategory : Form
    {
        ...
        private void btnAddCategory_Click(object sender, EventArgs e)
        {
            ...
            if (QLBS_BUS.Instance.GetBookCategoryByID(txbCategoryCode.Text.ToUpper().Trim()).Ma_TL != null)
            {
            ...
            theloai.Ma_TL = txbCategoryCode.Text.ToUpper();
        ...
        private void btnEditCategory_Click(object sender, EventArgs e)
        {
            ...
            if(txbCategoryCode.Text == QLBS_BUS.Instance.GetBookCategoryByID(txbCategoryCode.Text.ToUpper().Trim()).Ma_TL)
            {
        ...
        private void btnDeleteCategory_Click(object sender, EventArgs e)
        {
            if (txbCategoryCode.Text == QLBS_BUS.Instance.GetBookCategoryByID(txbCategoryCode.Text).Ma_TL)
            {
                ...
                {
                    if (sach.Ma_TL == theloai.Ma_TL)
                    {
                        MessageBox.Show("Thể loại này đang tồn tại trong kho!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                    }
                }
