...
namespace QuanLyBanSach
{
    public partial class FormAdmin : Form
    {
        ...
        {
            if (QLBS_BUS.Instance.GetStaffByCode(txbStaffCode.Text.ToUpper().Trim()).Ma_NV == txbStaffCode.Text.ToUpper().Trim())
            {
        ...
        {
            if (QLBS_BUS.Instance.GetStaffFromID(txbStaffCode.Text.ToUpper().Trim()).Ma_NV != txbStaffCode.Text.ToUpper().Trim())
            {
