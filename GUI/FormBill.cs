...
namespace QuanLyBanSach
{
    public partial class FormBill : Form
    {
        ...
        private void SetGUI()
        {
            ...
            txbIntoMoney.Text = "";
            txbTotalMoney.Text = lbReadNumber.Text = "";
            dtgvListBookSelected.DataSource = null;
        }
        ...
        private void btnCreateOrder_Click(object sender, EventArgs e)
        {
            ...
            {
                if(QLBS_BUS.Instance.GetHoaDonByID(txbOrderCode.Text.ToUpper().Trim()).Ma_HD == txbOrderCode.Text.ToUpper().Trim())
                {
            ...
            if (txbCustomerCode.Text == "")
            {
                ...
                {
                    hd.Ma_HD = txbOrderCode.Text.ToUpper();
                    hd.Ma_KH = "NoName";
            ...
            foreach (DataGridViewRow row in dtgvListBookSelected.Rows)
            {
                ...
                cthd.Ma_HD = hd.Ma_HD.ToUpper();
                cthd.Ma_S = row.Cells["Ma_S"].Value.ToString().ToUpper();
